...
const ui_exporter::Screen kGeneratedScreens[] = {
    ...
    { "config-sensors", "CFG.S — Sensors", kConfigSensorsElements, sizeof(kConfigSensorsElements) / sizeof(kConfigSensorsElements[0]), kConfigSensorsFlows, sizeof(kConfigSensorsFlows) / sizeof(kConfigSensorsFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "config-modbus-slave-id", "M1 — Modbus ID", kConfigModbusSlaveIdElements, sizeof(kConfigModbusSlaveIdElements) / sizeof(kConfigModbusSlaveIdElements[0]), kConfigModbusSlaveIdFlows, sizeof(kConfigModbusSlaveIdFlows) / sizeof(kConfigModbusSlaveIdFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-modbus-slave-id-edit", "M1.V — Edit Modbus ID", kConfigModbusSlaveIdEditElements, sizeof(kConfigModbusSlaveIdEditElements) / sizeof(kConfigModbusSlaveIdEditElements[0]), kConfigModbusSlaveIdEditFlows, sizeof(kConfigModbusSlaveIdEditFlows) / sizeof(kConfigModbusSlaveIdEditFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-modbus-baud-rate", "M2 — Baud Rate", kConfigModbusBaudRateElements, sizeof(kConfigModbusBaudRateElements) / sizeof(kConfigModbusBaudRateElements[0]), kConfigModbusBaudRateFlows, sizeof(kConfigModbusBaudRateFlows) / sizeof(kConfigModbusBaudRateFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "config-modbus-parity", "M3 — Parity", kConfigModbusParityElements, sizeof(kConfigModbusParityElements) / sizeof(kConfigModbusParityElements[0]), kConfigModbusParityFlows, sizeof(kConfigModbusParityFlows) / sizeof(kConfigModbusParityFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-modbus-parity-edit", "M3.V — Edit Parity", kConfigModbusParityEditElements, sizeof(kConfigModbusParityEditElements) / sizeof(kConfigModbusParityEditElements[0]), kConfigModbusParityEditFlows, sizeof(kConfigModbusParityEditFlows) / sizeof(kConfigModbusParityEditFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-modbus-stop-bits", "M4 — Stop Bits", kConfigModbusStopBitsElements, sizeof(kConfigModbusStopBitsElements) / sizeof(kConfigModbusStopBitsElements[0]), kConfigModbusStopBitsFlows, sizeof(kConfigModbusStopBitsFlows) / sizeof(kConfigModbusStopBitsFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "config-modbus-back", "M.BACK — Back", kConfigModbusBackElements, sizeof(kConfigModbusBackElements) / sizeof(kConfigModbusBackElements[0]), kConfigModbusBackFlows, sizeof(kConfigModbusBackFlows) / sizeof(kConfigModbusBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-display-led-volume", "D1 — LED Pulse Volume", kConfigDisplayLedVolumeElements, sizeof(kConfigDisplayLedVolumeElements) / sizeof(kConfigDisplayLedVolumeElements[0]), kConfigDisplayLedVolumeFlows, sizeof(kConfigDisplayLedVolumeFlows) / sizeof(kConfigDisplayLedVolumeFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-display-led-volume-edit", "D1.V — Edit LED Pulse Volume", kConfigDisplayLedVolumeEditElements, sizeof(kConfigDisplayLedVolumeEditElements) / sizeof(kConfigDisplayLedVolumeEditElements[0]), kConfigDisplayLedVolumeEditFlows, sizeof(kConfigDisplayLedVolumeEditFlows) / sizeof(kConfigDisplayLedVolumeEditFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-display-led-period", "D2 — LED Pulse Period", kConfigDisplayLedPeriodElements, sizeof(kConfigDisplayLedPeriodElements) / sizeof(kConfigDisplayLedPeriodElements[0]), kConfigDisplayLedPeriodFlows, sizeof(kConfigDisplayLedPeriodFlows) / sizeof(kConfigDisplayLedPeriodFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "config-display-flow-unit", "D3 — Flow unit", kConfigDisplayFlowUnitElements, sizeof(kConfigDisplayFlowUnitElements) / sizeof(kConfigDisplayFlowUnitElements[0]), kConfigDisplayFlowUnitFlows, sizeof(kConfigDisplayFlowUnitFlows) / sizeof(kConfigDisplayFlowUnitFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-display-flow-unit-edit", "D3.V — Edit Flow unit", kConfigDisplayFlowUnitEditElements, sizeof(kConfigDisplayFlowUnitEditElements) / sizeof(kConfigDisplayFlowUnitEditElements[0]), kConfigDisplayFlowUnitEditFlows, sizeof(kConfigDisplayFlowUnitEditFlows) / sizeof(kConfigDisplayFlowUnitEditFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "config-display-back", "D.BACK — Back", kConfigDisplayBackElements, sizeof(kConfigDisplayBackElements) / sizeof(kConfigDisplayBackElements[0]), kConfigDisplayBackFlows, sizeof(kConfigDisplayBackFlows) / sizeof(kConfigDisplayBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "config-s3-pulses-per-l", "S3 — Pulses per litre", kConfigS3PulsesPerLElements, sizeof(kConfigS3PulsesPerLElements) / sizeof(kConfigS3PulsesPerLElements[0]), kConfigS3PulsesPerLFlows, sizeof(kConfigS3PulsesPerLFlows) / sizeof(kConfigS3PulsesPerLFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 1 },
    { "config-s3-pulses-per-l-edit", "S3.V — Edit Pulses per litre", kConfigS3PulsesPerLEditElements, sizeof(kConfigS3PulsesPerLEditElements) / sizeof(kConfigS3PulsesPerLEditElements[0]), kConfigS3PulsesPerLEditFlows, sizeof(kConfigS3PulsesPerLEditFlows) / sizeof(kConfigS3PulsesPerLEditFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 1 },
    { "config-s4-multiplier", "S4 — Multiplier (F)", kConfigS4MultiplierElements, sizeof(kConfigS4MultiplierElements) / sizeof(kConfigS4MultiplierElements[0]), kConfigS4MultiplierFlows, sizeof(kConfigS4MultiplierFlows) / sizeof(kConfigS4MultiplierFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 0 },
    { "config-s4-multiplier-edit", "S4.V — Edit Multiplier (F)", kConfigS4MultiplierEditElements, sizeof(kConfigS4MultiplierEditElements) / sizeof(kConfigS4MultiplierEditElements[0]), kConfigS4MultiplierEditFlows, sizeof(kConfigS4MultiplierEditFlows) / sizeof(kConfigS4MultiplierEditFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 0 },
    { "config-s5-adjust", "S5 — Adjust", kConfigS5AdjustElements, sizeof(kConfigS5AdjustElements) / sizeof(kConfigS5AdjustElements[0]), kConfigS5AdjustFlows, sizeof(kConfigS5AdjustFlows) / sizeof(kConfigS5AdjustFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 0 },
    { "config-s5-adjust-edit", "S5.V — Edit Adjust", kConfigS5AdjustEditElements, sizeof(kConfigS5AdjustEditElements) / sizeof(kConfigS5AdjustEditElements[0]), kConfigS5AdjustEditFlows, sizeof(kConfigS5AdjustEditFlows) / sizeof(kConfigS5AdjustEditFlows[0]), nullptr, 0, nullptr, 0, "config.sensor.calibrationType", 0 },
    ...
    { "config-sensor-settings-reset-cal", "S.RESET — Reset calibration", kConfigSensorSettingsResetCalElements, sizeof(kConfigSensorSettingsResetCalElements) / sizeof(kConfigSensorSettingsResetCalElements[0]), kConfigSensorSettingsResetCalFlows, sizeof(kConfigSensorSettingsResetCalFlows) / sizeof(kConfigSensorSettingsResetCalFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "confirm-reset-totals-back", "Reset totals — Back", kConfirmResetTotalsBackElements, sizeof(kConfirmResetTotalsBackElements) / sizeof(kConfirmResetTotalsBackElements[0]), kConfirmResetTotalsBackFlows, sizeof(kConfirmResetTotalsBackFlows) / sizeof(kConfirmResetTotalsBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "confirm-reset-session-back", "Reset session — Back", kConfirmResetSessionBackElements, sizeof(kConfirmResetSessionBackElements) / sizeof(kConfirmResetSessionBackElements[0]), kConfirmResetSessionBackFlows, sizeof(kConfirmResetSessionBackFlows) / sizeof(kConfirmResetSessionBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "confirm-reset-max-flow", "Reset peak flow?", kConfirmResetMaxFlowElements, sizeof(kConfirmResetMaxFlowElements) / sizeof(kConfirmResetMaxFlowElements[0]), kConfirmResetMaxFlowFlows, sizeof(kConfirmResetMaxFlowFlows) / sizeof(kConfirmResetMaxFlowFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "confirm-reset-max-flow-back", "Reset peak flow — Back", kConfirmResetMaxFlowBackElements, sizeof(kConfirmResetMaxFlowBackElements) / sizeof(kConfirmResetMaxFlowBackElements[0]), kConfirmResetMaxFlowBackFlows, sizeof(kConfirmResetMaxFlowBackFlows) / sizeof(kConfirmResetMaxFlowBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    { "confirm-reset-calibration", "Reset calibration?", kConfirmResetCalibrationElements, sizeof(kConfirmResetCalibrationElements) / sizeof(kConfirmResetCalibrationElements[0]), kConfirmResetCalibrationFlows, sizeof(kConfirmResetCalibrationFlows) / sizeof(kConfirmResetCalibrationFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "confirm-factory-reset-back", "Factory reset — Back", kConfirmFactoryResetBackElements, sizeof(kConfirmFactoryResetBackElements) / sizeof(kConfirmFactoryResetBackElements[0]), kConfirmFactoryResetBackFlows, sizeof(kConfirmFactoryResetBackFlows) / sizeof(kConfirmFactoryResetBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "confirm-reset-portal-login-back", "Reset portal login — Back", kConfirmResetPortalLoginBackElements, sizeof(kConfirmResetPortalLoginBackElements) / sizeof(kConfirmResetPortalLoginBackElements[0]), kConfirmResetPortalLoginBackFlows, sizeof(kConfirmResetPortalLoginBackFlows) / sizeof(kConfirmResetPortalLoginBackFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "toast-max-flow-reset", "Peak flow reset", kToastMaxFlowResetElements, sizeof(kToastMaxFlowResetElements) / sizeof(kToastMaxFlowResetElements[0]), kToastMaxFlowResetFlows, sizeof(kToastMaxFlowResetFlows) / sizeof(kToastMaxFlowResetFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 },
    ...
    { "toast-calibration-reset", "Calibration reset", kToastCalibrationResetElements, sizeof(kToastCalibrationResetElements) / sizeof(kToastCalibrationResetElements[0]), kToastCalibrationResetFlows, sizeof(kToastCalibrationResetFlows) / sizeof(kToastCalibrationResetFlows[0]), nullptr, 0, nullptr, 0, nullptr, 0 }
};
...
const ui_exporter::Theme kGeneratedTheme = {
    "StampPLC Default", kThemeColors, sizeof(kThemeColors) / sizeof(kThemeColors[0]), 8, 10, 8
};
