...
constexpr SimpleValue kSimpleValues[] = {
    ...
    {"net.mqtt.lastCommandResult", ValueCategory::Derived, ValueType::String, nullptr,
     plc::net_reg::kMqttLastCmdResult, ValueSource::Network, false,
     "Outcome of the last MQTT command topic (R4.4.2d) — accepted, rate-limited, ..."},
