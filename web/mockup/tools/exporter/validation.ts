...
import type { ExportIR, ValidationCheck, ValidationReport } from "./types.js";
...
export function runExportValidations(dataset: ScreenDataset, ir: ExportIR): ValidationReport {
