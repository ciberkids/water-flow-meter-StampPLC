...
const SENSOR = [
  ...
  ["OFF_CFG_ADJUST", "rw", "i16", "—", "Formula calibration: the additive term in `F = mult*Q + adjust`. A negative offset lowers the ceiling frequency `mult*Q + adjust`; if that reaches zero or below there is nothing to sample and the write is refused and flagged in register 30 rather than installed. Note a negative offset within the accepted bound still makes zero pulses read as positive flow — see the offset-bound entry in `docs/active_work/open_decisions.md`."],
